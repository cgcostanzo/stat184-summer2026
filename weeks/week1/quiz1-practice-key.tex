...
\begin{itemize}
\tightlist
\item Try the practice quiz first \textbf{without} looking at the key.
\end{itemize}
...
\begin{quote}
Why: scalar arithmetic on a vector is applied \textbf{elementwise}.
\end{quote}
