...
Three pieces: YAML header, prose, code chunk. The output will be a polished HTML page.
...
::: {.callout-tip}
**YAML** stands for "YAML Ain't Markup Language." Cute, but mostly you just need to know it's how Quarto reads settings.
:::
