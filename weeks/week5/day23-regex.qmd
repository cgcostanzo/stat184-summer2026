...
| :--- | :--- | :--- |
| `.` | **Any single character** (except a newline) | `".ble"` matches "**able**", "sol**uble**", or "B**ible**". |
| `^` | **Start of the string** | `"^a"` matches "**a**pple" but not "b**a**nana". |
| `$` | **End of the string** | `"e$"` matches "appl**e**" but not "**e**lephant". |
| `[ ]` | **Character class** (matches *any one* character inside) | `"[ab]c"` matches "**ac**" or "**bc**". |
...
- **Quiz 4** rescheduled to **Mon Jun 22**
