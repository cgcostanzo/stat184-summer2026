...
Work through the steps in order. Each links to the matching chapter of [**Happy Git with R**](https://happygitwithr.com/) (Jenny Bryan) — read its instructions; this page is the checklist. **Expect a snag or two.** Part 5 is the troubleshooting playbook, and office hours exist for exactly this.
...
- [ ] **Register a GitHub account** — [happygitwithr.com/github-acct](https://happygitwithr.com/github-acct). Pick a username that's professional-ish; you may reuse it for years.
...
- [ ] **Introduce yourself to Git** — [hello-git](https://happygitwithr.com/hello-git). Set your name and the email tied to your GitHub account. Easiest from the R console:
