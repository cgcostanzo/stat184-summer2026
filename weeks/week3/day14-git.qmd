...
## Helpful for solo work too {.scrollable .nostretch}
...
## The distinction {.scrollable .nostretch}

People often use "git" as a catch-a;;, but there's actually two pieces:
...
# Daily workflow {background-color="#001E44"}

## Four workflow steps {.scrollable .nostretch}
