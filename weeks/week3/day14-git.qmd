...
## Git + Teamwork {.scrollable .nostretch}
...
## Common issues {.scrollable .nostretch}
...
::: {.callout-warning}
When truly stuck, Happy Git's [troubleshooting](https://happygitwithr.com/troubleshooting) chapter and the ["Burn it all down"](https://happygitwithr.com/burn) escape hatch (re-clone a fresh copy) will probably help.
:::
...
- [Activity Canvas Link](https://psu.instructure.com/courses/2487468/assignments/18326660?module_item_id=48204757)
