---
title: "Day 7 Activity: ggplot2 internals with `storms`"
...
## 1.1 --- Mapping vs. setting {.scrollable}
...
## 1.3 --- The `group` aesthetic {.scrollable}
...
## 1.5 --- Position adjustments {.scrollable}
