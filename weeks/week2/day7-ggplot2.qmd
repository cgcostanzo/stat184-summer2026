...
## Mapping vs. setting {.scrollable .nostretch}
...
## The classic mistake {.scrollable .nostretch}
...
## Example: status mapped four ways {.scrollable .nostretch}
...
## The `stroke` aesthetic {.scrollable .nostretch}
...
## On-the-fly transformations {.scrollable .nostretch}
...
## Layering: more than one geom {.scrollable .nostretch}
...
## Global vs. local mappings {.scrollable .nostretch}
...
## Why local mappings matter {.scrollable .nostretch}
...
## Different data per layer {.scrollable .nostretch}
...
## The `group` aesthetic {.scrollable .nostretch}
...
## Where do bar heights come from? {.scrollable .nostretch}
...
## Three reasons to touch the stat {.scrollable .nostretch}
...
## `after_stat()` quick overview {.scrollable .nostretch}
...
## Stacking (the default for filled bars) {.scrollable .nostretch}
...
## `position = "fill"` {.scrollable .nostretch}
...
## `position = "dodge"` {.scrollable .nostretch}
...
## Jittering --- for scatterplots, not bars {.scrollable .nostretch}
...
## Don't over-jitter {.scrollable .nostretch}
